...
for index in indices:
    try:
        ...
        np.save(OUTPUTDIRECTORY + "frequency_data_" + str(index) + ".npy", np.array(fs_axion_all))
        np.save(OUTPUTDIRECTORY + "amplitude_data_" + str(index) + ".npy", np.array(As_axion_all))
        np.save(OUTPUTDIRECTORY + "frequency_peaks_" + str(index) + ".npy", np.array(fs_axion))
        np.save(OUTPUTDIRECTORY + "amplitude_peaks_" + str(index) + ".npy", np.array(As_axion))
