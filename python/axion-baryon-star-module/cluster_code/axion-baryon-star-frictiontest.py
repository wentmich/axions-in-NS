...
from matter_and_metric_solver_frictest import *
...
DATADIRECTORY         = "/scratch/wentzel4/axions-in-NS/total-dynamics/outputs/SIM_frictest8_" + str(PARAMETERINDEX)
...
LINFRIC      = PARAMETERSET[PARAMETERINDEX, 3]
DENSFRIC     = PARAMETERSET[PARAMETERINDEX, 4]
...
for i in range(Nt):
    ...
    newvals = matter_and_metric_solver_frictest(rvals, Fv, Gv, nNv, Uv, Av, Pv, epsilon, fa, dt, nNRadiusCUT, LINFRIC, DENSFRIC)
    #print("number density is changing: " + str(newvals[2*Nr:3*Nr]==nNv))
    ...
    if i%RESOLUTION == 0:
        ...
        print("Total non causal steps: " + str(total_non_causal))
